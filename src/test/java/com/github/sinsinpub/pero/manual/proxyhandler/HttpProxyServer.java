    ...
    private final class HttpIntermediaryHandler extends IntermediaryHandler {
        ...
        protected boolean handleProxyProtocol(ChannelHandlerContext ctx, Object msg)
            ...
            if (!authenticate(ctx, req)) {
                ...
                assertThat(lastColonPos, Matchers.is(Matchers.greaterThan(0)));
                intermediaryDestination = new InetSocketAddress(uri.substring(0, lastColonPos),
                        Integer.parseInt(uri.substring(lastColonPos + 1)));
            }
