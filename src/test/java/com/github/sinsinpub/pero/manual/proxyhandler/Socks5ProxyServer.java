...
final class Socks5ProxyServer extends ProxyServer {
    ...
    Socks5ProxyServer(int port) {
        super(false, TestMode.INTERMEDIARY, null, null, null, port, true);
    }
    ...
    private final class Socks5IntermediaryHandler extends IntermediaryHandler {
        ...
        protected boolean handleProxyProtocol(ChannelHandlerContext ctx, Object msg)
            ...
            assertThat(req.type(), Matchers.is(Socks5CommandType.CONNECT));

            Socks5CommandResponse res = new DefaultSocks5CommandResponse(
    ...
    private final class Socks5TerminalHandler extends TerminalHandler {
        ...
        protected boolean handleProxyProtocol(ChannelHandlerContext ctx, Object msg)
            ...
            ctx.pipeline().addBefore(ctx.name(), "lineDecoder",
                    new LineBasedFrameDecoder(64, false, true));
            ...
            if (!req.dstAddr().equals(destination.getHostString())
                ...
                res = new DefaultSocks5CommandResponse(Socks5CommandStatus.FORBIDDEN,
                        Socks5AddressType.IPv4);
            } else {
                res = new DefaultSocks5CommandResponse(Socks5CommandStatus.SUCCESS,
                        Socks5AddressType.IPv4);
                sendGreeting = true;
            }
